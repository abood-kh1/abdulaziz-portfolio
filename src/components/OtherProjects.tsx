      ...
      <div className="mx-auto max-w-6xl px-5 py-16 md:px-8 md:py-20">
        <Reveal>
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              <p className="rule-label text-accent">{t.otherProjects.label}</p>
            ...
            <p className="font-mono text-[11px] tracking-[0.16em] text-dim uppercase">{t.otherProjects.subtitle}</p>
          </div>
        </Reveal>
        <ul className="mt-8 grid gap-px overflow-hidden rounded-xl border border-line bg-line sm:grid-cols-2">
          {t.otherProjects.items.map((p, i) => (
